inventory = [
  ...
  ["Electric keyboard", "This keyboard is capable of recreating a wide range of
    ...
    home users, beginners and other non-professional users.", 550, 5, "", "Piano's"],
  ...
  ["Classic guitar", "Spanish classi guitar for a warm and southren sound", 300, 4, "", "Guitars"],

  ["Drumsticks", "High quality drumsticks. Best in the world!", 10, 10, "", "Drums"],

  ["Stradivarius Violin", "The fine and extreme expensive violin. Best in the world!", 10000, 10, "", "Violins"],

  ["Yamaha Violin", "Good quality violin", 350, 10, "", "Violins"],

  ["Pearl Drumset", "High quality drumset. Best in the world!", 800, 10, "", "Drums"]
]
